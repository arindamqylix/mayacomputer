			...
			<div class="page-card">
				<div class="list-header">
					<div class="list-header-inner">
						<h4>
							<span class="header-icon"><i class="fas fa-certificate"></i></span>
							Course Certificates
				...
				<div class="card-body">
					...
					<div class="info-banner">
						...
						<span>These are your diploma/course certificates linked to published results. For typing courses, use the <strong>Typing Certificate</strong> menu.</span>
					</div>
									...
									<tbody>
										...
										@foreach($certificates as $cert)
											<tr>
												...
												<td>
													<span class="stat-pill">{{ $cert->sr_percentage ?? '—' }}%</span>
													<span class="grade-badge ms-1">{{ $cert->sr_grade ?? '—' }}</span>
												</td>
												<td>
					...
					@else
						<div class="empty-state">
							...
							<p>Your certificate will appear here once your center generates it after your result is published.</p>
