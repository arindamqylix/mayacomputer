                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.success && response.data) {
                            // Redirect to the separate registration card view page
                            var viewUrl = "{{ route('verification.registration.card') }}";
                            var regNo = $('#registration_no').val();
                            var dob = formatDateForDB($('#dob').val());

                            window.location.href = viewUrl + '?registration_no=' + regNo + '&dob=' + dob;
                        } else {
