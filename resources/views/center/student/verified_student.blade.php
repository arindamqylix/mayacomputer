			...
			<div class="card-body p-0">
							...
							<tbody>
								@foreach($student as $data)
									<tr>
										...
										<td>
											<span class="status-badge verified">{{ $data->sl_status ?? 'VERIFIED' }}</span>
										</td>
										<td>
				...
				@else
					<div class="text-center p-5">
						<i class="fas fa-check-circle" style="font-size: 4rem; color: #6c757d; opacity: 0.5;"></i>
						<h5 class="mt-3">No Verified Students Found</h5>
						<p class="text-muted">Verified students will appear here once they are verified by admin.</p>
					</div>
				@endif
			</div>
		</div>
