			...
			<div class="card-body p-0">
							...
							<tbody>
								@foreach($student as $data)
									<tr>
										...
										<td>
											<span class="status-badge result-out">{{ $data->sl_status ?? 'RESULT OUT' }}</span>
										</td>
										<td>
				...
				@else
					<div class="text-center p-5">
						<i class="fas fa-trophy" style="font-size: 4rem; color: #6c757d; opacity: 0.5;"></i>
						<h5 class="mt-3">No Result Out Students Found</h5>
						<p class="text-muted">Students with results published will appear here.</p>
					</div>
				@endif
			</div>
		</div>
