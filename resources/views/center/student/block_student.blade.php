			...
			<div class="card-body p-0">
							...
							<tbody>
								@foreach($student as $data)
									<tr>
										...
										<td>
											<a href="{{ route('edit.student', $data->sl_id) }}" class="btn-view">
				...
				@else
					<div class="text-center p-5">
						<i class="fas fa-ban" style="font-size: 4rem; color: #6c757d; opacity: 0.5;"></i>
						<h5 class="mt-3">No Blocked Students Found</h5>
						<p class="text-muted">Blocked students will appear here if any.</p>
					</div>
				@endif
			</div>
		</div>
