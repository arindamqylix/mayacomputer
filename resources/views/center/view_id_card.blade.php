            ...
            <div class="id-footer">
                <div class="footer-content">
                    ...
                    <div class="qr-section">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ url('verify-id-card/' . ($data->sl_id ?? '')) }}"
                            alt="QR"
                    ...
                    <div class="signature-wrapper">
                        <div class="signature-section">
                            @if($setting && !empty($setting->authorize_stamp) && file_exists(public_path($setting->authorize_stamp)))
                                <img src="{{ asset($setting->authorize_stamp) }}" class="footer-stamp" alt="Stamp">
                            @endif

                            @if($setting && !empty($setting->authorize_signature) && file_exists(public_path($setting->authorize_signature)))
