...
<div class="row mt-3">
	<div class="col-lg-12">
		<form id='update_frm' method="POST" action="{{ route('edit_result', $student_data->sl_id) }}">
			@csrf
			<div class="card modern-card">
				...
				<div class="card-body p-4">
							...
							<div class="form-group">
								...
								<select name="student_id" class="form-select" required>
									...
									@foreach($student as $data)
										<option value="{{ $data->sl_id }}" {{ (isset($student_data) && $data->sl_id == $student_data->sl_id) ? 'selected' : '' }}>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group mb-3">
									...
									<input type="number" value="{{ $result->sr_wr_marks_obtained ?? '' }}" class="form-control" name="wr_marks_obtained" placeholder="Marks Obtained" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="subject-card">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group mb-3">
									<label>Marks Obtained</label>
									<input type="number" value="{{ $result->sr_pr_marks_obtained ?? '' }}" class="form-control" name="pr_marks_obtained" placeholder="Marks Obtained" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="subject-card">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group mb-3">
									<label>Marks Obtained</label>
									<input type="number" value="{{ $result->sr_ap_marks_obtained ?? '' }}" class="form-control" name="ap_marks_obtained" placeholder="Marks Obtained" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="subject-card">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group mb-3">
									<label>Marks Obtained</label>
									<input type="number" value="{{ $result->sr_vv_marks_obtained ?? '' }}" class="form-control" name="vv_marks_obtained" placeholder="Marks Obtained" required>
								</div>
							</div>
						</div>
					</div>
					...
					<button type="submit" class="btn-save mt-4 w-100" id="update_btn">
						<i class="fas fa-save"></i>
						UPDATE RESULT
					</button>
				</div>
