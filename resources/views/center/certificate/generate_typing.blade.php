                                    ...
                                    <tbody>
                                        ...
                                        @foreach($students as $student)
                                            <tr>
                                                ...
                                                <form action="{{ route('center.typing_certificate_store') }}" method="POST"
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        if ($num > 0) {
                                                                            if (str_contains($duration, 'year') || str_contains($duration, 'Yr')) {
                                                                                $calculatedDate = $regDate->copy()->addYears($num)->format('Y-m-d');
                                                                            } elseif (str_contains($duration, 'month') || str_contains($duration, 'mon')) {
                                                                                $calculatedDate = $regDate->copy()->addMonths($num)->format('Y-m-d');
                                                                            }
                                                                        }
                                                                    } catch (\Exception $e) {
                                                                        // Fallback to today
