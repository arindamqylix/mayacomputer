			...
			<div class="modern-card">
				<div class="result-list-header">
					<div class="d-flex justify-content-between align-items-center">
						...
						<a href="{{ route('admin.set_result') }}" class="btn-set-result">
					...
					<div class="row align-items-center">
						<div class="col-md-4">
							<div class="search-input-wrapper">
								...
								<input type="text" id="searchInput" class="form-control" placeholder="Search by registration number, student name, center name, grade...">
							</div>
						</div>
						<div class="col-md-4">
							<select class="form-select" id="centerFilter" onchange="window.location.href='{{ route('admin.result_list') }}?center_id='+this.value">
						...
						<div class="col-md-4 text-end">
							<span class="text-muted">
								...
								Total Results: <strong>{{ count($result) }}</strong>
							</span>
						</div>
					</div>
				</div>
				...
				<div class="card-body p-0">
								...
								<tbody>
									...
									@foreach($result as $data)
										<tr>
											...
											<td>
												<span class="center-name">{{ $data->cl_center_name ?? $data->center_name ?? 'N/A' }}</span><br>
												<small class="center-code">({{ $data->cl_code ?? $data->center_code ?? 'N/A' }})</small>
											</td>
											<td>
					...
					@else
						<div class="empty-state">
							...
							<a href="{{ route('admin.set_result') }}" class="btn-set-result mt-3">
								<i class="fas fa-plus-circle"></i>
								Set New Result
							</a>
						</div>
