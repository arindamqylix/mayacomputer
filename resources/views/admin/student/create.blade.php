                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header card-header-gradient d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="mb-0 opacity-75" style="font-size: 14px;">Fill in all the required information to
                        ...
                        <div class="card-body p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="input-icon-wrapper">
                                            ...
                                            <select onchange="get_reg_no(this.value);" class="form-select" name='center_id'
                                                id='center_id' required>
                                                <option value=''> Select Center </option>
                                                @foreach($center as $data)
                                                    <option value="{{ $data->cl_id }}">{{ $data->cl_name }}
                                                        [{{ $data->cl_code }}]</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <label class="form-label">Enter Student Name <span
                                                class="required-star">*</span></label>
                                        <div class="input-icon-wrapper">
                                            <i class="fas fa-user"></i>
                                            <input class="form-control" placeholder="Student Name Here" name='student_name'
                                                value='' required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        <label class="form-label">Enter Mother's Name <span
                                                class="required-star">*</span></label>
                                        <div class="input-icon-wrapper">
                                            <i class="fas fa-female"></i>
                                            <input class="form-control" placeholder="Mother's Name" name='student_mother'
                                                value='' required>
                                        </div>
                                    </div>

                                    <div class="col-md-4 mb-4">
                                        <label class="form-label">Enter Father's Name <span
                                                class="required-star">*</span></label>
                                        <div class="input-icon-wrapper">
                                            <i class="fas fa-male"></i>
                                            <input class="form-control" placeholder="Father's Name" name='student_father'
                                                value='' required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="input-icon-wrapper">
                                            ...
                                            <input class="form-control" type='date' name='date_of_birth' max='2015-01-01'
                                                value='' required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <label class="form-label">Select Qualification <span
                                                class="required-star">*</span></label>
                                        <div class="input-icon-wrapper">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="input-icon-wrapper">
                                            ...
                                            <textarea class="form-control" rows="3" name='student_address'
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <label class="form-label">Enter Mobile No. <span
                                                class="required-star">*</span></label>
                                        <div class="input-icon-wrapper">
                                            <i class="fas fa-phone"></i>
                                            <input class="form-control" type='tel' pattern='[0-9]{10}' name='student_mobile'
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <label class="form-label">Enter Email Id. <span
                                                class="required-star">*</span></label>
                                        <div class="input-icon-wrapper">
                                            <i class="fas fa-envelope"></i>
                                            <input class="form-control" placeholder="someone@email.com" name='student_email'
                                                type='email' value=''>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        <label class="form-label">Upload Photograph <span
                                                class="required-star">*</span></label>
                                        <div class="file-upload-wrapper">
                                            ...
                                            <input class="file-upload-input" type='file' name='student_photo' id='uploadimg'
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <label class="form-label">Upload Identity Card <span
                                                class="required-star">*</span></label>
                                        <div class="file-upload-wrapper">
                                            ...
                                            <input class="file-upload-input" type='file' name='student_id_card'
                                                id='upload_id_proof' accept='image/*,application/pdf' required>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <label class="form-label">Upload Educational Certificate <span
                                                class="required-star">*</span></label>
                                        <div class="file-upload-wrapper">
                                            ...
                                            <input class="file-upload-input" type='file'
                                                name='student_educational_certificate' id='upload_edu_proof'
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <label class="form-label">Upload Signature <span
                                                class="required-star">*</span></label>
                                        <div class="file-upload-wrapper">
                                            ...
                                            <input class="file-upload-input" type='file' name='student_signature'
                                                id='upload_signature' accept='image/*' required>
