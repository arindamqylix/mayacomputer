		...
		<div class="card modern-card">
			...
			<div class="search-section">
				<div class="row align-items-center">
					...
					<div class="col-md-4">
						<select class="form-select" id="centerFilter" onchange="window.location.href='{{ route('admin.student.id_card_list') }}?center_id='+this.value">
						...
						<tbody>
							...
							@foreach($student as $data)
								<tr>
									...
									<td>
                                        <a href="{{ route('student_id_card_view', $data->sl_id) }}" target="_blank" class="btn-view-card">
