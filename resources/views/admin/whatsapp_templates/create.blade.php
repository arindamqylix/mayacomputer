    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.whatsapp_templates.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="template_name" class="form-control" value="{{ old('template_name') }}" required placeholder="e.g., Student Registration, Exam Reminder">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="message" class="form-control" rows="8" required placeholder="Enter your message. Use {variable_name} for dynamic content.">{{ old('message') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="variables" class="form-control" value="{{ old('variables') }}" placeholder="name, course, center, date">
