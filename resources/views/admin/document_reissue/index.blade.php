...
@section('title', 'Document Reissue Requests')
@push('custom-css')
<style type="text/css">
	.reissue-header {
					...
					<div class="row">
						<div class="col-md-6">
							<div class="search-input-wrapper">
								...
								<input type="text" id="searchInput" class="form-control" placeholder="Search by request ID, student name, registration number...">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card-body">
								...
								<tbody>
									@foreach($requests as $req)
										<tr>
											...
											<td>
												<a href="{{ route('admin.document_reissue.show', $req->drr_id) }}" class="btn-view">
					...
					@else
						<div class="alert alert-info text-center">
							...
							No document reissue requests found.
						</div>
					@endif
				</div>
			</div>
