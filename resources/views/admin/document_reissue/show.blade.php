...
@section('title', 'Manage Document Reissue Request')
@push('custom-css')
<style type="text/css">
	.manage-header {
			...
			<div class="modern-card">
				<div class="manage-header">
					<h4>
						...
						Manage Document Reissue Request
					</h4>
				</div>
				<div class="card-body p-4">
					...
					<div class="info-card">
						...
						<div class="info-row">
							...
							<span class="info-value">{{ $request->cl_center_name ?? 'N/A' }} ({{ $request->cl_code ?? 'N/A' }})</span>
						</div>
						
						<div class="info-row">
							<span class="info-label">Amount:</span>
							<span class="info-value"><strong>₹ {{ number_format($request->drr_amount, 2) }}</strong></span>
						</div>
						...
						<div class="info-row">
							...
							<span class="info-value">{{ \Carbon\Carbon::parse($request->drr_requested_at)->format('d M, Y h:i A') }}</span>
						</div>
						...
						<div class="info-row">
							...
							<span class="info-value">{{ \Carbon\Carbon::parse($request->drr_processed_at)->format('d M, Y h:i A') }}</span>
						</div>
						@endif
					...
					<div class="action-card">
						...
						<form action="{{ route('admin.document_reissue.update_status', $request->drr_id) }}" method="POST" class="mb-3">
							@csrf
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<select class="form-select" id="status" name="status" required>
											...
											<option value="PAID" {{ $request->drr_status == 'PAID' ? 'selected' : '' }}>PAID</option>
