...
<div class="row mt-3">
	<div class="col-lg-12">
		<form method="POST" id="insert_frm" action="{{ route('admin.handle_admit_card') }}">
			@csrf
			...
			<div class="card modern-card">
				...
				<div class="filter-section">
					<div class="filter-row">
						<div class="filter-group">
							...
							<input type="text" class="form-control" id="searchStudent" placeholder="Search by name, registration number, course, center...">
						</div>
						<div class="filter-group">
							<label>
								...
								<tbody id="studentTableBody">
									@foreach($students as $student)
										<tr data-student-id="{{ $student->sl_id }}" data-course-id="{{ $student->sl_FK_of_course_id }}">
											...
											<td>
												<span class="badge-center">{{ $student->center_name ?? $student->cl_center_name ?? 'N/A' }}</span>
											</td>
										</tr>
									@endforeach
								</tbody>
				...
				<div class="info-card">
					...
					<ul>
						<li>One admit card is generated per course — a student in ADCA and Typing appears twice (once per course)</li>
						<li>Only verified enrollments without an existing admit card for that course are listed</li>
						<li>You can select multiple rows at once for bulk admit card generation</li>
						<li>Use filters to quickly find students by name, registration number, course, or center</li>
					</ul>
				</div>
				
				<!-- Submit Button -->
				<div class="card-body p-4">
					<button type="submit" class="btn-create" id="insert_btn" disabled>
