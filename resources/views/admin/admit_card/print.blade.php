    ...
    <div class="admit-card">
        ...
        <div class="header">
            ...
            <div class="header-right">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=70x70&data={{ $admit->reg_no }}" alt="QR Code" class="qr-code">
            </div>
        </div>
        ...
        <div class="student-section">
            <div class="student-details">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value">{{ $center->cl_code ?? '' }}- {{ strtoupper($center->cl_name ?? 'N/A') }}</div>
                </div>
                <div class="detail-row">
