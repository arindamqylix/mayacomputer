						...
						<div class="col-md-4">
							<div class="search-input-wrapper">
								...
								<input type="text" id="searchInput" class="form-control"
									placeholder="Search by registration number, student name, center, venue...">
							</div>
						</div>
						<div class="col-md-4">
							<select class="form-select" id="centerFilter"
								onchange="window.location.href='{{ route('admin.admit_card_list') }}?center_id='+this.value">
										...
										<tr>
											...
											<td>
												<div class="d-flex gap-2">
													...
													<a href="{{ route('admin.download_admit_card', $val->ac_id) }}"
