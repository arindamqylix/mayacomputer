			...
			<div class="modern-card">
				<div class="dispatch-header">
					<h4>
						...
						Dispatch Certificate via Courier
					</h4>
				</div>
				<div class="card-body p-4">
					...
					<div class="info-card">
						...
						@if($certificate->cl_center_address)
						<div class="info-row">
							<span class="info-label">Center Address:</span>
							<span class="info-value">{{ $certificate->cl_center_address }}</span>
						</div>
						@endif
					...
					<!-- Dispatch Form -->
					<form action="{{ route('admin.courier.update', $certificate->sc_id) }}" method="POST">
						@csrf
						<div class="row">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<input type="text" 
										   ...
										   placeholder="e.g., Blue Dart, DTDC, India Post, Speed Post" 
										   required>
								</div>
							</div>
						...
						<div class="mt-4">
							<a href="{{ route('admin.courier.index') }}" class="btn-back">
								<i class="fas fa-arrow-left"></i>
								Back to Courier List
							</a>
							<button type="submit" class="btn-submit">
								<i class="fas fa-save"></i>
								{{ $certificate->sc_dispatch_date ? 'Update' : 'Save' }} Dispatch Information
							</button>
						</div>
					</form>
				</div>
