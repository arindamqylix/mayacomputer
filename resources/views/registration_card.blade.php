                ...
                <div class="main-body">
                    <div class="left-section">
                        <table class="info-table">
                            ...
                            <tr>
                                ...
                                <td class="colon">:</td>
                                <td class="value">{{ strtoupper($data->c_full_name ?? 'N/A') }}</td>
                            </tr>
                            <tr>
                    ...
                    <div class="right-section">
                        ...
                        <div class="validity-box">
                            ...
                            <p class="date">{{ \Carbon\Carbon::parse($data->created_at ?? now())->format('d-M-Y') }}</p>
                            <p><strong>Valid Till:</strong></p>
                            <p class="date">{{ \Carbon\Carbon::parse($data->created_at ?? now())->addYear()->format('d-M-Y') }}</p>
                        </div>
                    </div>
                </div>
                        ...
                        <tr>
                            <td width="25%">
                                <div class="footer-item">
                                    ...
                                    <p class="value">{{ \Carbon\Carbon::parse($data->created_at ?? now())->format('d-M-Y') }}</p>
                                </div>
                            </td>
                            <td width="25%">
                                <div class="footer-item">
